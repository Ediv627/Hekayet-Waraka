...
import { ShoppingCart, User, LogOut, Menu, X, Home, Package, Settings, Search } from 'lucide-react';
...
const Header = ({ onCartClick }: HeaderProps) => {
  ...
  const navLinks = [
    ...
    { to: '/track', label: 'تتبع الطلب', icon: Search },
  ];
      ...
      <div className="container mx-auto flex h-16 md:h-20 items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center gap-2 md:gap-3">
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] md:text-xs text-muted-foreground hidden sm:block">Hekayet Waraka</p>
          </div>
        </Link>
