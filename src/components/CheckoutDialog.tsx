      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        {orderSent ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="mb-4 font-arabic text-lg text-primary">
              سنتواصل معك قريباً لتأكيد الطلب
            </p>

            {submittedOrder && (
              <div className="w-full rounded-lg border border-primary/20 bg-primary/5 p-4 mb-4 text-right">
                <p className="text-xs text-muted-foreground mb-1">رقم الطلب (احفظه لتتبع طلبك):</p>
