                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      <div>
                        ...
                        {item.selectedVariant && (
                          <div className="mt-1 inline-flex items-center gap-1.5 rounded-md bg-primary/10 border border-primary/20 px-2 py-0.5">
                            <span className="text-xs font-bold text-primary">{item.selectedVariant.label}</span>
                            {item.selectedVariant.pageCount ? (
                              <span className="text-[11px] text-primary/80">• {item.selectedVariant.pageCount} ورقة</span>
                            ) : null}
                          </div>
                        )}
            ...
            <div className="border-t border-border pt-4">
              <div className="mb-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-primary">يُحسب عند الدفع</span>
                </div>
                <Separator />
